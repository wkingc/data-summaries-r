...
setMethod(
    ...
    definition = function(object) 
    {
        if (object@byLab == "") {
            print(
                kable(
                    object@table, caption = paste("Summary statistics of ", object@xLab, ".", sep = ""), booktabs = TRUE) %>% 
                    kable_styling(bootstrap_options = c("striped", "hover")))
        } else {
            print(
                kable(
                    object@table, caption = paste("Summary statistics of ", object@xLab, " by ", object@byLab, ".", sep = ""), booktabs = TRUE) %>% 
                    kable_styling(bootstrap_options = c("striped", "hover")))
        }
    }
)
...
## Categorical By {.tabset .tabset-fade .tabset-pills}
...
## Categorical By By {.tabset .tabset-fade .tabset-pills}
...
## Continuous {.tabset .tabset-fade .tabset-pills}
...
## Continuous By {.tabset .tabset-fade .tabset-pills}
...
## Continuous By By {.tabset .tabset-fade .tabset-pills}
...
## Date By {.tabset .tabset-fade .tabset-pills}
...
## Date By By {.tabset .tabset-fade .tabset-pills}
...
## POSIXlt Date {.tabset .tabset-fade .tabset-pills}
...
## POSIXlt Date By {.tabset .tabset-fade .tabset-pills}
...
## POSIXlt Date By By {.tabset .tabset-fade .tabset-pills}
...
## POSIXct Date {.tabset .tabset-fade .tabset-pills}
...
## POSIXct Date By {.tabset .tabset-fade .tabset-pills}
...
## POSIXct Date By By {.tabset .tabset-fade .tabset-pills}
...
## Difftime {.tabset .tabset-fade .tabset-pills}
...
## Difftime By {.tabset .tabset-fade .tabset-pills}
...
## Difftime By By {.tabset .tabset-fade .tabset-pills}
...
# Data Summaries {.tabset .tabset-fade .tabset-pills}

## Manufacturer

The results are in table \@ref(tab:manuSummary) and figure \@ref(fig:manuSummary).
...
The results are in table \@ref(tab:modelSummary) and figure \@ref(fig:modelSummary).
...
The results are in table \@ref(tab:displSummary) and figure \@ref(fig:displSummary).
...
The results are in table \@ref(tab:yearSummary) and figure \@ref(fig:yearSummary).
...
The results are in table \@ref(tab:dpSummary) and figure \@ref(fig:dpSummary).
...
The results are in table \@ref(tab:cylSummary) and figure \@ref(fig:cylSummary).
...
The results are in table \@ref(tab:transSummary) and figure \@ref(fig:transSummary).
...
The results are in table \@ref(tab:drvSummary) and figure \@ref(fig:drvSummary).
...
The results are in table \@ref(tab:ctySummary) and figure \@ref(fig:ctySummary).
...
The results are in table \@ref(tab:hwySummary) and figure \@ref(fig:hwySummary).
...
The results are in table \@ref(tab:flSummary) and figure \@ref(fig:flSummary).
...
The results are in table \@ref(tab:classSummary) and figure \@ref(fig:classSummary).
...
The results are in table \@ref(tab:rnSummary) and figure \@ref(fig:rnSummary).
...
The results are in table \@ref(tab:rdifftimeSummary) and figure \@ref(fig:rdifftimeSummary).
...
The results are in table \@ref(tab:logicalSummary) and figure \@ref(fig:logicalSummary).
...
The results are in table \@ref(tab:partySummary) and figure \@ref(fig:partySummary).
...
The results are in table \@ref(tab:commentsSummary) and figure \@ref(fig:commentsSummary).
...
The results are in table \@ref(tab:missSummary) and figure \@ref(fig:missSummary).
...
## By Drive Type {.tabset .tabset-fade .tabset-pills}

### Number of Cylinders by Drive Type

The results are in table \@ref(tab:cylByDrvSummary) and figure \@ref(fig:cylByDrvSummary).
...
The results are in table \@ref(tab:dpByDrvSummary) and figure \@ref(fig:dpByDrvSummary).
...
The results are in table \@ref(tab:rnByDrvSummary) and figure \@ref(fig:rnByDrvSummary).
...
The results are in table \@ref(tab:rdifftimeByDrvSummary) and figure \@ref(fig:rdifftimeByDrvSummary).
...
The results are in table \@ref(tab:logicalByDrvSummary) and figure \@ref(fig:logicalByDrvSummary).
...
The results are in table \@ref(tab:commentsByDrvSummary) and figure \@ref(fig:commentsByDrvSummary).
...
The results are in table \@ref(tab:missByDrvSummary) and figure \@ref(fig:missByDrvSummary).
...
## City and Highway MPG {.tabset .tabset-fade .tabset-pills}

### City MPG by Manufacturer

The results are in table \@ref(tab:ctyBymanuSummary) and figure \@ref(fig:ctyBymanuSummary).
...
The results are in table \@ref(tab:hwyBymanuSummary) and figure \@ref(fig:hwyBymanuSummary).
...
The results are in table \@ref(tab:ctyBymodelSummary) and figure \@ref(fig:ctyBymodelSummary).
...
The results are in table \@ref(tab:hwyBymodelSummary) and figure \@ref(fig:hwyBymodelSummary).
...
The results are in table \@ref(tab:ctyByYearSummary) and figure \@ref(fig:ctyByYearSummary).
...
The results are in table \@ref(tab:hwyByYearSummary) and figure \@ref(fig:hwyByYearSummary).
...
The results are in table \@ref(tab:ctyByCylSummary) and figure \@ref(fig:ctyByCylSummary).
...
The results are in table \@ref(tab:hwyByCylSummary) and figure \@ref(fig:hwyByCylSummary).
...
The results are in table \@ref(tab:ctyBytransSummary) and figure \@ref(fig:ctyBytransSummary).
...
The results are in table \@ref(tab:hwyBytransSummary) and figure \@ref(fig:hwyBytransSummary).
...
The results are in table \@ref(tab:ctyByDrvSummary) and figure \@ref(fig:ctyByDrvSummary).
...
The results are in table \@ref(tab:hwyByDrvSummary) and figure \@ref(fig:hwyByDrvSummary).
...
The results are in table \@ref(tab:ctyByflSummary) and figure \@ref(fig:ctyByflSummary).
...
The results are in table \@ref(tab:hwyByflSummary) and figure \@ref(fig:hwyByflSummary).
...
The results are in table \@ref(tab:ctyByclassSummary) and figure \@ref(fig:ctyByclassSummary).
...
The results are in table \@ref(tab:hwyByclassSummary) and figure \@ref(fig:hwyByclassSummary).
...
The results are in table \@ref(tab:ctyByCommentsSummary) and figure \@ref(fig:ctyByCommentsSummary).
...
The results are in table \@ref(tab:hwyByCommentsSummary) and figure \@ref(fig:hwyByCommentsSummary).
...
The results are in table \@ref(tab:ctyByPartySummary) and figure \@ref(fig:ctyByPartySummary).
...
The results are in table \@ref(tab:hwyByPartySummary) and figure \@ref(fig:hwyByPartySummary).
...
The results are in table \@ref(tab:ctyByMissSummary) and figure \@ref(fig:ctyByMissSummary).
...
The results are in table \@ref(tab:hwyByMissSummary) and figure \@ref(fig:hwyByMissSummary).
...
## Other Examples {.tabset .tabset-fade .tabset-pills}

### Date of Purchase by Year of Manufacture

The results are in table \@ref(tab:dpByYearSummary) and figure \@ref(fig:dpByYearSummary).
...
The results are in table \@ref(tab:dpByCommentsSummary) and figure \@ref(fig:dpByCommentsSummary).
...
The results are in table \@ref(tab:rnByPartySummary) and figure \@ref(fig:rnByPartySummary).
...
The results are in table \@ref(tab:rdifftimeByPartySummary) and figure \@ref(fig:rdifftimeByPartySummary).
...
The results are in table \@ref(tab:rdifftimeByCommentsSummary) and figure \@ref(fig:rdifftimeByCommentsSummary).
...
The results are in table \@ref(tab:commentsByPartySummary) and figure \@ref(fig:commentsByPartySummary).
...
# By By Data Summaries {.tabset .tabset-fade .tabset-pills}
...
The results are in table \@ref(tab:dpByCylByCommentsSummary) and figure \@ref(fig:dpByCylByCommentsSummary).
...
The results are in table \@ref(tab:commentsByCylByClassSummary) and figure \@ref(fig:commentsByCylByClassSummary).
...
kable(cars_univariate_data_summary, caption = "Data summaries", booktabs = TRUE, escape = FALSE, format = "html") %>% kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
```
...
kable(cars_by_data_summary, caption = "Data summaries", booktabs = TRUE, escape = FALSE, format = "html") %>% kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
```
...
kable(cars_bivariate_data_summary, caption = "By data summaries of miles per gallons for city and highway.", booktabs = TRUE, escape = FALSE, format = "html") %>% kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
kable(cars_bivariate_time_data_summary, caption = "By data summaries of miles per gallons for city and random difference in time.", booktabs = TRUE, escape = FALSE, format = "html") %>% kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
```
...
<!-- The example data is based on venerable cars data set, however because we generally like to know the answer ahead of time when testing methods, we will setup the data generating process. -->

<!-- > This dataset contains a subset of the fuel economy data that the EPA makes available <a href="http://fueleconomy.gov" target="_blank">here</a>. It contains only models which had a new release every year between 1999 and 2008 - this was used as a proxy for the popularity of the car. -->

<!-- The example data is based on venerable cars data set, however because we generally like to know the answer ahead of time when testing methods, we will setup the data generating process based on these data.  Also because we want to make sure the code works for a variety of use cases, we will add in a few variables with different classes. -->

<!-- Let's assume that the conditional distribution of both city and highway MPG $y_i$ for the $i^{th}$ observation is normal with mean equal to the linear predictor, $\eta$, and constant error variance $\sigma_{\epsilon}^2$.  Let $I$ be the indicator function that codes a variable at 0 or 1 (e.g., dummy factor coding). -->

<!-- $$ -->
<!-- \eta = \beta_{0} + \beta_1I(cyl = 5) + \beta_2I(cyl = 6) + \beta_3I(cyl = 8) -->
<!-- $$ -->

<!-- $$ -->
<!-- y_i \sim N(\eta, \sigma_{\epsilon}^2) -->
<!-- $$ -->

<!-- ```{r cars, eval = TRUE, echo = TRUE, results = TRUE, warning = FALSE, message = FALSE} -->
<!-- head(mpg) -->
<!-- ``` -->
